...
export interface InboxMethods {
     ...
     */
    findMessages(searchQuery: SearchQuery | string): any;
    /**
     ...
     */
    waitTillMessage(searchQuery: SearchQuery | string, shouldLogEvents: boolean, timeTillNextCallInSeconds: number, maxWaitTimeInSeconds: number): Promise<Message[]>;
}
